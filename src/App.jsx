...
export default function App() {
  ...
  useEffect(() => {
    ...
    const vars = {
      ...
      velvet:   { '--bg-900':'#0a0005','--bg-800':'#140008','--bg-700':'#1e000d','--bg-600':'#2e0015','--bg-500':'#40001e','--accent':'#c8003a','--accent-fg':'#0a0005','--t1':'#fff0f3','--t2':'#ffc2cf','--t3':'#ff8099','--t4':'#ff4060','--t5':'#c8003a','--t6':'#96002a','--border':'#3d0018' },
      barbie:   { '--bg-900':'#1a0022','--bg-800':'#2e0040','--bg-700':'#420060','--bg-600':'#600080','--bg-500':'#7800a0','--accent':'#ff10f0','--accent-fg':'#1a0022','--t1':'#fff0ff','--t2':'#ffccff','--t3':'#ff99ff','--t4':'#ff55ff','--t5':'#ff10f0','--t6':'#cc00cc','--border':'#6600aa' },
